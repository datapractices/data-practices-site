$(document).ready(function() {
    ...
    $('.social-link.twitter').on('click', function(e) {
      e.preventDefault();
      window.open('https://twitter.com/home?status=The%20Data%20Practices%20Manifesto%20and%20Community%20Principles%20for%20Ethical%20Data%20Sharing%20https%3A%2F%2Fhubs.ly%2FH09W81F0', '_blank', 'top=0,left=500,width=600,height=400');
      return false
    });
    ...
    $('.social-link.twitter-ethics').on('click', function(e) {
      e.preventDefault();
      window.open('https://twitter.com/home?status=The%20CPEDS%20(Community%20Principles%20for%20Ethical%20Data%20Sharing)%20movement%20is%20underway!%20Join%20the%20effort%20at%20https%3A%2F%2Fhubs.ly%2FH09W81F0', '_blank', 'top=0,left=500,width=600,height=400');
      return false
    });
});
