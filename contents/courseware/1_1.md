...
<section data-background="#0747A6">
  <div class="full">
    ...
    <p><h1 class="color-white smaller">1.1 Kicking off a data project</h1></p>
  </div>
  <aside class="notes">
...
<section>
  <div class="full">
    ...
    <p class="badge">10 minute exercise</p>
  </div>
</section>
...
<section>
  <div class="full">
    <h2 class="larger">Map your <u>three</u> most impactful questions to their key stakeholder.</h2>
  ...
  <div class="half text-align-left">
    ...
    <div class="full">
      <img class="no-shadow" src="/images/courses/1_1/stickies-how-might.png"/>
    </div>
  </div>
  <div class="half text-align-left">
    <div class="half">
...
<section>
  <h2 class="larger">As a group, discuss your clarified questions and refine further.</h2>
  <div class="one-third">
    <h2>Original</h2>
  </div>
  <div class="one-third">
...
<section class="align-middle" data-background="#f2f2f2">
  ...
  <div class="half white-background box-shadow xlarge-padding">
    <h2 class="thin larger">How might we double revenue in the next 12 months?</h2>
    <div class="half text-align-left">
      <h2>Marketing</h2>
      <p>Cares about:</p>
      <ul>
...
<section>
  <div class="full">
    <h2 class="larger">Express results however you want.</h2>
...
<section>
  <div class="half text-align-left">
    <h2 class="larger">Brainstorm how best to communicate the results.</h2>
  ...
  <div class="full">
    <p class="badge">5 min, individual</p>
  </div>
</section>

<section>
  <div class="half text-align-left">
    <h2 class="larger">Present and discuss solutions within your group.</h2>
