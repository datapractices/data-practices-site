...
<section>
	...
	<div class="full">
		<img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window1.gif">
		<img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window2.gif">
		<img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window3.gif">
	</div>
	<aside class="notes">
	Notes
	</aside>
