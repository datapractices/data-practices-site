...
<section>
	...
	<div class="full">
		<table class="table table-borderless">
			<tr>
				<td><img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window1.gif"></td>
				<td rowspan="2"><img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window3.gif"></td>
			</tr>
			<tr>
				<td><img class="no-shadow" style="height:20%"  src="/images/courses/2_7/window2.gif"></td>
			</tr>
		</table>		
	</div>
	<aside class="notes">
