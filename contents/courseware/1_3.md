...
<section data-background="#0747A6">
  <div class="full">
    ...
    <p><h2 class="color-white">1.3 Profile and Prepare</h1></p>
  </div>
  <div class="full">
...
<section data-background="#0747A6">
    <div class="half text-align-left">
        ...
        <p class="color-white"><b>Suggested Data:</b> <a target="_blank" href="https://data.world/exercises/data-wrangling-exercise-1/workspace/file?filename=Crime_2015.csv">https://goo.gl/SxHBhh</a></p>
    </div>
    <div class="half">
    	<h2 class="color-white">[IMAGE]</h2>
    </div>
